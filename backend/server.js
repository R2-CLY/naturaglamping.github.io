...
app.listen(PORT, () => {
  ...
  console.log(`📊 Stats: https://naturaglampinggithubio-production.up.railway.app/api/stats`);
  console.log(`📈 History: https://naturaglampinggithubio-production.up.railway.app/api/history`);
});